...
- Нет автоматической обработки разрыва соединений, приходиться при обратном вызове отлавливать ошибки через catch{ } и удалять килентов с которыми потеряно соединение(который выдал исключение)
</details>
